...
if(NOT TARGET wirespy_client)
    if(NOT EXISTS "${VSPYSHARK_WIRESPY_DIR}/src/client/CMakeLists.txt")
        message(FATAL_ERROR "Set VSPYSHARK_WIRESPY_DIR to the independent wirespy repository")
    endif()
    add_subdirectory("${VSPYSHARK_WIRESPY_DIR}/src/client" "${CMAKE_CURRENT_BINARY_DIR}/wirespy_client")
endif()
if(NOT VSPYSHARK_IMGUI_TARGET)
    ...
    if(VSPYSHARK_TEST_ENGINE)
        target_compile_definitions(shark_imgui PUBLIC IMGUI_ENABLE_TEST_ENGINE)
    endif()
    set(VSPYSHARK_IMGUI_TARGET shark_imgui)
elseif(NOT TARGET "${VSPYSHARK_IMGUI_TARGET}")
    message(FATAL_ERROR "VSPYSHARK_IMGUI_TARGET must name an existing target")
endif()
